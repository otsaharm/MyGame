...
struct ContentView: View {
    @AppStorage("hasWatchedIntroVideo") private var hasWatchedIntroVideo: Bool = false
    @State private var isSplashActive = true
    @State private var showQuestion = false
    @State private var currentQuestion = 1
    @State private var skipCount27 = 0
    let answers27 = ["القمر", "", "الشمس", "زحل"]
    ...
    var body: some View {
        if isSplashActive {
            ...
            Video1(
                onBack: {
                    showVideo = false
                    hasWatchedIntroVideo = true
                }
            )
        } else if !showQuestion {
            // ✅ StartPage خارج أي NavigationStack
            StartPage(
                onStart: {
                    showQuestion = true
                },
            ...
            // ✅ NavigationStack فقط حول الأسئلة
            NavigationStack {
