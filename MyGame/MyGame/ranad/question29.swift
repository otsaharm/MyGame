...
struct Question29: View {
    ...
    // Correct answer is left down (index 0)
    let correctIndex = 0
        ...
        GeometryReader { geometry in
            VStack(spacing: 0) {
                ...
                VStack(spacing: 18) {
                    ...
                    // Question text
                    Text("لو عندك دلو فيه فتحة من تحت، وش تسوي عشان ماينكب المويه")
                    ...
                    VStack(spacing: 20) {
                        HStack(spacing: 24) {
                            answerButton(index: 1) // left up
                            answerButton(index: 3) // right up
                        }
                        HStack(spacing: 24) {
                            answerButton(index: 0) // left down (correct)
                            answerButton(index: 2) // right down
                        }
                    }
                    .padding(.horizontal, 16)
